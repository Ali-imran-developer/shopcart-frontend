...
import { replaceUnderscoreDash } from '@utils/helperFunctions/replace-underscore-dash';
...
const allStatus = {
  ...
  refunded: statusColors.warning,
  open: statusColors.success,
  confirmed: statusColors.success,
  manual: statusColors.warning,
  booked: statusColors.success,
  reselling: statusColors.success,
};
