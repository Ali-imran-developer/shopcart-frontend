...
const metricCardClasses = {
  base: "border border-muted bg-gray-0 py-5 px-2 dark:bg-gray-50 lg:px-2 lg:py-5",
  rounded: {
    sm: "rounded-sm",
    DEFAULT: "rounded-lg",
    lg: "rounded-xl",
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center">
          ...
          <div className={cn(icon && "ps-3", contentClassName)}>
            ...
            <Text
              className={cn(
                "font-lexend text-base font-semibold text-gray-900 2xl:xl:text-xl dark:text-gray-700",
                metricClassName
              )}
            >
              {metric}
