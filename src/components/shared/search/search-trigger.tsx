...
export default function SearchTrigger({
  ...
  return (
    <button
      aria-label="Search"
      className={cn(
        "group inline-flex items-center focus:outline-none active:translate-y-px xl:h-10 xl:w-full xl:max-w-sm xl:rounded-lg xl:border xl:border-muted xl:py-2 xl:pe-2 xl:ps-0 xl:shadow-sm xl:backdrop-blur-md xl:transition-colors xl:duration-200 xl:hover:border-gray-900 xl:hover:outline-double xl:hover:outline-[0.5px] xl:hover:outline-gray-900 xl:focus-visible:border-gray-900 xl:focus-visible:outline-double xl:focus-visible:outline-[0.5px] xl:focus-visible:outline-gray-900",
        className
      )}
      {...props}
    >
      {icon ? (
        ...
        <PiMagnifyingGlassBold className="magnifying-glass ms-2 me-2 h-[18px] w-[18px]" />
      )}
      <span
        className={cn(
