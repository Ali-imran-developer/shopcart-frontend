...
import { updateThemeColor } from "@utils/helperFunctions/update-theme-color";
import { presetDark, presetLight } from "@config/color-presets";
import { useEffect } from "react";
import { useColorPresetName } from "@layouts/settings/use-theme-color";
import LightMode from "@shared/components/icons/light-mode";
import DarkMode from "@shared/components/icons/dark-mode";
