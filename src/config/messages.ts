export const messages = {
  ...
  sellingOnlineIsRequired: "Please Select one Option!",
  amenitiesAreRequired: "Please Select one Option!",
  thisFieldIsRequired: "Please Select one Option!",
  ...
  sharedSecretKeyIsRequired: "Shared secret key is required",
...
export const courierMessages = {
  apiMessage: "Please enter api key",
  password: "please enter password",
  securityMessage: "please enter security key",
};
